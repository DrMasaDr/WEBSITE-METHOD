...
echo -e "\t${colors[rand1]}    /      _,-\ O_O-_/ )  "
echo -e "\t${colors[rand1]}    \     / ,  '   . '|       TELEGRAM CH 1: @program_masa & TELEGRAM CH 2 : @Minds_Tech  & TELEGRAM CONTACT 1 : @Dr_Masa_Dr &  CONTACT 2 : @DXDMASA  "
echo -e "\t${colors[rand1]}     '-..-| \-.,__~ ~ /                    FACEBOOK PAGE : @Masaaofficial FACEBOOK CONTACT : @DXDMASA "
